...
# Author: Aaron Buller
# 2/13/23
# Description: This code will resample the Q5 codes at the sample rate of the SDR
...
def main():
    ...
    # Load the code
    with open("../Codes/Q5_BaseCodes.json") as file:
        Q5_json = json.load(file)


    # Pull out the list of PRNs
    prns = list(Q5_json.keys())
    ...
    for prn in prns:
        ...
        # Print the length of the new code
        print(len(new))
    ...
    with open("../Codes/Q5_ResampledCodes.json",'w') as file:
